...
export function generateClaudeMd(data: ProjectData): string {
...
**Time Constraints:** ${userProfile.time_constraints || '_Not specified_'}
...
export async function generateAndDownloadClaudeMd(projectId: string): Promise<boolean> {
