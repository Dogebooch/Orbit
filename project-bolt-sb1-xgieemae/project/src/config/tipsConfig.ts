...
export const STAGE_TIPS: TipConfig[] = [
  ...
  {
    id: 'workbench-session-golden-rule',
    stage: 'workbench',
    trigger: 'first-visit',
    variant: 'warning',
    title: 'Golden Rule: One Session Per Feature',
    content: 'The most important rule for AI-assisted development: Start new chat sessions for new features. When you reuse the same conversation for multiple features, the AI mixes contexts—applying decisions from Feature A to Feature B, leading to inconsistent code and subtle bugs.',
    dismissible: false,
  },
  {
    id: 'workbench-session-management',
    stage: 'workbench',
    trigger: 'always',
    variant: 'info',
    title: 'Prevent Context Pollution',
    content: 'Context pollution happens when AI conversations grow too long and cover multiple features. The AI starts forgetting constraints and mixing styling/logic from different features. Check the Session Indicator in the header—green means healthy, yellow means consider a new session, red means start fresh.',
    dismissible: true,
  },
  {
    id: 'workbench-new-session-for-feature',
    stage: 'workbench',
    trigger: 'always',
    variant: 'pro-tip',
    title: 'When to Start New Sessions',
    content: 'Start a new AI session when: (1) Starting a new feature, (2) Your session has 3+ tasks, (3) Session is 2+ hours old, or (4) Switching to unrelated work like debugging. The Session Manager helps you track and manage this.',
    dismissible: true,
  },
  {
    ...
    content: 'The TaskMaster workflow is iterative: Review Tasks → Select Next → Refresh Context → Implement → Smoke Test → Commit → Repeat. Use the Workflow Guide above to stay on track. Each iteration builds on the last.',
    dismissible: true,
  },
  {
  ...
  {
    id: 'workbench-three-task-rule',
    stage: 'workbench',
    trigger: 'always',
    variant: 'warning',
    title: 'The 3-Task Warning',
    content: 'After 3 tasks in one session, context pollution risk increases significantly. The AI may: apply styling from Task 1 to Task 3, forget constraints you set in Task 2, or mix business logic between features. Watch the Session Indicator—when it turns yellow, start a new session.',
    dismissible: true,
  },
  {
  ...
  // ============================================
  {
    id: 'maintenance-weekly-review',
    stage: 'maintenance',
    trigger: 'always',
    variant: 'info',
    title: 'Weekly Review Process',
    content: 'Schedule a weekly 30-minute review to assess user feedback, technical health, and priorities. Consistent reviews prevent small issues from becoming big problems.',
    dismissible: true,
  },
  {
    id: 'maintenance-feedback-collection',
    stage: 'maintenance',
    trigger: 'incomplete',
    variant: 'warning',
    title: 'Start Collecting Feedback',
    content: 'User feedback is the lifeblood of product improvement. Add your first feedback item or create a weekly review to start tracking your project\'s health.',
    dismissible: false,
  },
  {
    id: 'maintenance-categorize-feedback',
    stage: 'maintenance',
    trigger: 'always',
    variant: 'pro-tip',
    title: 'Categorize Feedback Properly',
    content: 'Separate feedback into: Positive (what to keep), Pain Points (what to fix), and Feature Requests (what to add). This makes prioritization easier.',
    dismissible: true,
  },
  {
    id: 'maintenance-technical-health',
    stage: 'maintenance',
    trigger: 'always',
    variant: 'info',
    title: 'Monitor Technical Health',
    content: 'Track error rates, performance metrics, and usage patterns. Sudden spikes often indicate bugs or UX issues that need immediate attention.',
    dismissible: true,
  },
  {
    id: 'maintenance-first-visit',
    stage: 'maintenance',
    trigger: 'first-visit',
    variant: 'info',
    title: 'Post-Launch Best Practices',
    content: 'After launching, the real work begins. Use this stage to systematically collect user feedback, monitor technical health, and plan improvements. Regular maintenance prevents technical debt from accumulating.',
    dismissible: true,
  },
  {
    ...
    trigger: 'complete',
    variant: 'success',
    title: 'Great Maintenance Habits!',
    content: 'You\'re actively tracking feedback and conducting reviews. Keep up the weekly rhythm to maintain a healthy, growing product.',
    dismissible: true,
  },
];
