...
export const STAGE_TIPS: TipConfig[] = [
  ...
  },
  {
    ...
    trigger: 'always',
    variant: 'info',
    title: 'Manage AI Sessions',
    content: 'Track your AI conversation sessions to prevent context pollution. Start a new session when switching to a different feature or after completing 3+ tasks. The session indicator shows your current session health.',
    dismissible: true,
  },
  {
    ...
    content: 'Each major feature should have its own AI session. This keeps conversations focused and prevents the AI from mixing contexts between unrelated features.',
    dismissible: true,
  },
